...
First thing to note is that `describe()` does not include the `Name` column. It shows only the _numerical_ data. From this we can see that Iris Setosa is not a very versatile flower: deviations from the mean are quite small and the vast majority of flowers are quite similar in every way with the exception of _Petal Width_, which has outliers about six times the mean width.
